...
class WriteOnlyWidgetSerializer(object):
    ...
    def __init__(self, name=None, dashboard=None, widgettype=None, description=None, metrics=None, stattype=None, columns=None, rows=None, x_position=None, y_position=None, channel_group=None):  # noqa: E501
