...
class ReadOnlyUserReadSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, firstname, lastname, organization, *args, **kwargs):  # noqa: E501
        """ReadOnlyUserReadSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, firstname, lastname, organization, *args, **kwargs):  # noqa: E501
        """ReadOnlyUserReadSerializer - a model defined in OpenAPI
