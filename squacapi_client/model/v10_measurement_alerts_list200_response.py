...
class V10MeasurementAlertsList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([ReadOnlyAlertDetailSerializer],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """V10MeasurementAlertsList200Response - a model defined in OpenAPI

        Args:
            count (int):
            results ([ReadOnlyAlertDetailSerializer]):
