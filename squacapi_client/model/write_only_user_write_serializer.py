...
class WriteOnlyUserWriteSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, email, password, firstname, lastname, groups, organization, *args, **kwargs):  # noqa: E501
        """WriteOnlyUserWriteSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, email, password, firstname, lastname, groups, organization, *args, **kwargs):  # noqa: E501
        """WriteOnlyUserWriteSerializer - a model defined in OpenAPI
