...
class V10NslcMatchingRulesList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([ReadOnlyMatchingRuleSerializer],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """V10NslcMatchingRulesList200Response - a model defined in OpenAPI

        Args:
            count (int):
            results ([ReadOnlyMatchingRuleSerializer]):
