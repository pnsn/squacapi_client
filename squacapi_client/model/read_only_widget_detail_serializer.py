...
class ReadOnlyWidgetDetailSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, dashboard, *args, **kwargs):  # noqa: E501
        """ReadOnlyWidgetDetailSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, dashboard, *args, **kwargs):  # noqa: E501
        """ReadOnlyWidgetDetailSerializer - a model defined in OpenAPI
