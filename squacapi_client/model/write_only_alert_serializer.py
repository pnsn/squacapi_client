...
class WriteOnlyAlertSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, trigger, timestamp, message, *args, **kwargs):  # noqa: E501
        """WriteOnlyAlertSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, trigger, timestamp, message, *args, **kwargs):  # noqa: E501
        """WriteOnlyAlertSerializer - a model defined in OpenAPI
