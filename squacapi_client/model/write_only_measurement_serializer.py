...
class WriteOnlyMeasurementSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, metric, channel, value, starttime, endtime, *args, **kwargs):  # noqa: E501
        """WriteOnlyMeasurementSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, metric, channel, value, starttime, endtime, *args, **kwargs):  # noqa: E501
        """WriteOnlyMeasurementSerializer - a model defined in OpenAPI
