...
class WriteOnlyMonitorSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, channel_group, metric, interval_count, *args, **kwargs):  # noqa: E501
        """WriteOnlyMonitorSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, channel_group, metric, interval_count, *args, **kwargs):  # noqa: E501
        """WriteOnlyMonitorSerializer - a model defined in OpenAPI
