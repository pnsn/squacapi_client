...
class ReadOnlyUserMeSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, firstname, lastname, *args, **kwargs):  # noqa: E501
        """ReadOnlyUserMeSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, firstname, lastname, *args, **kwargs):  # noqa: E501
        """ReadOnlyUserMeSerializer - a model defined in OpenAPI
