...
class WriteOnlyUserMeSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, password, firstname, lastname, *args, **kwargs):  # noqa: E501
        """WriteOnlyUserMeSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, password, firstname, lastname, *args, **kwargs):  # noqa: E501
        """WriteOnlyUserMeSerializer - a model defined in OpenAPI
