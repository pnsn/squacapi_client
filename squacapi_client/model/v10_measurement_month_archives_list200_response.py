...
class V10MeasurementMonthArchivesList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([ReadOnlyArchiveMonthSerializer],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """V10MeasurementMonthArchivesList200Response - a model defined in OpenAPI

        Args:
            count (int):
            results ([ReadOnlyArchiveMonthSerializer]):
