...
class WriteOnlyChannelSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, station_code, network, lat, lon, elev, *args, **kwargs):  # noqa: E501
        """WriteOnlyChannelSerializer - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            azimuth (float): [optional]  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, station_code, network, lat, lon, elev, *args, **kwargs):  # noqa: E501
        """WriteOnlyChannelSerializer - a model defined in OpenAPI
