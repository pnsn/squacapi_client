...
class WriteOnlyGroupSerializer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'auto_include_channels': ([int],),  # noqa: E501
            'auto_exclude_channels': ([int],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, channels, organization, auto_include_channels, auto_exclude_channels, *args, **kwargs):  # noqa: E501
        """WriteOnlyGroupSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, channels, organization, auto_include_channels, auto_exclude_channels, *args, **kwargs):  # noqa: E501
        """WriteOnlyGroupSerializer - a model defined in OpenAPI
