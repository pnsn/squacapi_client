...
class V10MeasurementMetricsList200Response(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'count': (int,),  # noqa: E501
            'results': ([ReadOnlyMetricSerializer],),  # noqa: E501
    ...
    def _from_openapi_data(cls, count, results, *args, **kwargs):  # noqa: E501
        """V10MeasurementMetricsList200Response - a model defined in OpenAPI

        Args:
            count (int):
            results ([ReadOnlyMetricSerializer]):
