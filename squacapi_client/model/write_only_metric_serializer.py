...
class WriteOnlyMetricSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, code, unit, reference_url, *args, **kwargs):  # noqa: E501
        """WriteOnlyMetricSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, code, unit, reference_url, *args, **kwargs):  # noqa: E501
        """WriteOnlyMetricSerializer - a model defined in OpenAPI
