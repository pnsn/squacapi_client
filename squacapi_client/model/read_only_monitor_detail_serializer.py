...
def lazy_import():
    ...
    globals()['NslcGroup'] = NslcGroup
    globals()['Trigger'] = Trigger


class ReadOnlyMonitorDetailSerializer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, interval_count, *args, **kwargs):  # noqa: E501
        """ReadOnlyMonitorDetailSerializer - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, interval_count, *args, **kwargs):  # noqa: E501
        """ReadOnlyMonitorDetailSerializer - a model defined in OpenAPI
