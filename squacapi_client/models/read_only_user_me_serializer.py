...
class ReadOnlyUserMeSerializer(object):
    ...
    def __init__(self, email=None, firstname=None, lastname=None, is_staff=None, id=None, organization=None, is_org_admin=None, groups=None, _configuration=None):  # noqa: E501
