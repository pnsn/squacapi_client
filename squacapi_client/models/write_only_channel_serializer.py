...
class WriteOnlyChannelSerializer(object):
    ...
    def __init__(self, code=None, name=None, station_code=None, station_name=None, description=None, sample_rate=None, network=None, loc='--', lat=None, lon=None, elev=None, azimuth=None, dip=None, starttime=None, endtime=None):  # noqa: E501
