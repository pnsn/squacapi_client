...
class ReadOnlyArchiveHourSerializer(object):
    ...
    @property
    def sum(self):
        """Gets the sum of this ReadOnlyArchiveHourSerializer.  # noqa: E501


        :return: The sum of this ReadOnlyArchiveHourSerializer.  # noqa: E501
        :rtype: float
        """
        return self._sum
    ...
    @sum.setter
    def sum(self, sum):
        """Sets the sum of this ReadOnlyArchiveHourSerializer.


        :param sum: The sum of this ReadOnlyArchiveHourSerializer.  # noqa: E501
        :type: float
        """
